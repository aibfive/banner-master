...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private boolean onlyOneImageIndicatorVisibility = BannerConfig.ONLY_ONE_IMAGE_INDICATOR_VISIBILITY;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        onlyOneImageIndicatorVisibility = typedArray.getBoolean(R.styleable.Banner_only_one_image_indicator_visibility, onlyOneImageIndicatorVisibility);
    ...
    private void setBannerStyleUI() {
        // TODO: 2019/11/2 增加只有一张图片是否显示Indicator的功能，原先只有一张都是隐藏
        int visibility;
        if(count > 1){
            visibility = View.VISIBLE;
        }else if(count == 1){
            visibility = onlyOneImageIndicatorVisibility ? View.VISIBLE : View.GONE;
        }else{
    ...
    private void createIndicator() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            // TODO: 2019/11/2 将其隐藏，有了这个，会使椭圆图形失效。
